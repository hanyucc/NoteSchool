...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private AutoCompleteTextView idTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idTextView = (AutoCompleteTextView) findViewById(R.id.user_id);
    ...
    private void attemptLogin() {
        ...
        String email = idTextView.getText().toString();
        ...
        if (TextUtils.isEmpty(email)) {
            idTextView.setError(getString(R.string.error_field_required));
            focusView = idTextView;
            cancel = true;
        } else if (!isIdValid(email)) {
            idTextView.setError(getString(R.string.error_invalid_id));
            focusView = idTextView;
            cancel = true;
        }
